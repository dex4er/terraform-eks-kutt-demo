...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "4.56.0"
  constraints = ">= 3.28.0, >= 3.29.0, >= 3.72.0, >= 3.73.0, >= 4.0.0, >= 4.22.0, >= 4.30.0, >= 4.40.0, >= 4.47.0, >= 4.54.0, 4.56.0, < 5.0.0"
  hashes = [
